				...
				success: function (json) {
					if (json) {
						if (true === json.success && json.data.content) {
							...
							if (json.data.totalenterprises) {
								$('.totalenterprises strong').html(json.data.totalenterprises);
							}
							if (json.data.totalhousesbuilt) {
								$('.totalhousesbuilt strong').html(json.data.totalhousesbuilt);
							}
							if (json.data.totaljobscount) {
								$('.totaljobscount strong').html(json.data.totaljobscount);
							}
							if (json.data.totalco2saved) {
								$('.totalco2saved strong').html(json.data.totalco2saved);
							}
